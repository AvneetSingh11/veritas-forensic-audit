                ...
                if credit_state['credits'] <= 0:
                    ...
                    with st.spinner("Executing hybrid forensic algorithms..."):
                        try:
                            ...
                            st.session_state.audit_results.clear() # Prevent memory leaks
                ...
                if credit_state['credits'] <= 0:
                    ...
                    with st.spinner("Initializing Enterprise Multimodal Scanner..."):
                        try:
                            ...
                            st.session_state.total_scans += 1
                            st.session_state.visual_results.clear() # Prevent memory leaks
...
with tab_sim:
    ...
    st.markdown(f'<div style="width:100%; height:750px;">{html_data}</div>', unsafe_allow_html=True)
